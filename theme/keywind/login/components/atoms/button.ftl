<#macro kw color="" component="button" size="" rest...>
  <#switch color>
    <#case "primary">
      ...
      <#break>
    <#case "secondary">
      <#assign colorClass="bg-secondary-100 text-secondary-600 dark:text-secondary-400 focus:ring-secondary-600 hover:bg-secondary-200 hover:text-secondary-900">
      <#break>
    <#default>
      <#assign colorClass="bg-primary-600 text-white focus:ring-primary-600 hover:bg-primary-700">
  </#switch>
